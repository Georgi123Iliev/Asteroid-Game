...
class Spaceship
{
	...
	{
		bool operator()(const Projectile& pX,unsigned int xBound,unsigned int yBound) const 
		{
...
public:
	...
	const auto ProjDrawables() const
	{
	...
	bool hasHitTarget(const std::pair<sf::Vector2f, float>& asteroidParams) 
	{
		auto hit = false;
